# freebuff2api 文档 / Documentation

欢迎！freebuff2api 的完整文档同时提供**中文**与**英文**两个版本，内容语义
一致，分别放在 `zh/` 与 `en/` 目录下。

Welcome! The full freebuff2api documentation is available in both **Chinese**
and **English** with semantically identical content, under the `zh/` and
`en/` directories.
